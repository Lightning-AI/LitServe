...
LitServe is at least [2x faster](#performance) than plain FastAPI, and we've seen ~[200x faster](https://lightning.ai/docs/litserve/home/speed-up-serving-by-200x) with all features enabled.
