...
def run_batched_loop(
    ...
    while True:
        ...
        try:
            ...
            callback_runner.trigger_event(EventTypes.AFTER_DECODE_REQUEST, lit_api=lit_api, request_queue=request_queue)

            x = lit_api.batch(x)

            callback_runner.trigger_event(EventTypes.BEFORE_PREDICT, lit_api=lit_api, request_queue=request_queue)
...
def run_streaming_loop(
    ...
    while True:
        ...
        try:
            ...
            callback_runner.trigger_event(EventTypes.AFTER_PREDICT, lit_api=lit_api, request_queue=request_queue)
